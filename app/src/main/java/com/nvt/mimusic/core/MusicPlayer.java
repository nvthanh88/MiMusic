...
public class MusicPlayer {
    ...
    public static MiCoreService mService = null;
    ...
    public static void shuffleAll(final Context context) {
        Cursor cursor = SongDataLoader.makeSongCursor(context, null, null);
        final long[] mTrackList = SongDataLoader.getSongListForCursor(cursor);
    ...
    /*public static final long[] getSongListForArtist(final Context context, final long id) {
        ...
        if (cursor != null) {
            final long[] mList = SongDataLoader.getSongListForCursor(cursor);
            cursor.close();
            cursor = null;
            return mList;
        }
...
*/
    ...
    public static final class ServiceBinder implements ServiceConnection {
        ...
        public void onServiceConnected(final ComponentName className, final IBinder service) {
            mService = MiCoreService.Stub.asInterface(service);
            if (mCallback != null) {
