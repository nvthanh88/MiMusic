...
public class TopSongAdapter extends RecyclerView.Adapter<TopSongAdapter.ViewHolder>{
    ...
    public TopSongAdapter(List<Song> songList, Activity mAppContext) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_top_song,parent,false);
